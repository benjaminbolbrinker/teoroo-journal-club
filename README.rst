...
Arguably, this implementation is not the most efficient and has a time complexity of :raw-math:`O(2^N)`.
E.g. calculating the 46th number requires :raw-math:`2^{46}` recursive descents and a summation of :math:`2^{46} - 1` terms.
